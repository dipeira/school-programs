...
### 3. Ρύθμιση Σύνδεσης (Database)
Ανοίξτε το αρχείο `conf.php` και συμπληρώστε τα στοιχεία της βάσης σας:
```php
$prDbhost = 'localhost';
...
### 4. Ρύθμιση Εφαρμογής (Metadata)
Ανοίξτε το αρχείο `config.json` για να ορίσετε τις βασικές παραμέτρους (έτος, διαχειριστές):
```json
[
    {
        "name": "prSxetos",
        "description": "Τρέχον σχολικό έτος",
        "value": "2025-26"
    },
    ...
]
