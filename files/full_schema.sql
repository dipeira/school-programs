CREATE DATABASE IF NOT EXISTS `school-programs`;
USE `school-programs`;
...
ALTER TABLE `progs` ADD PRIMARY KEY (`id`);
ALTER TABLE `progs` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Table structure for table `progs_schools`
--
...
ALTER TABLE `progs_schools` ADD PRIMARY KEY (`id`);
ALTER TABLE `progs_schools` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
